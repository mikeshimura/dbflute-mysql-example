...
func Create_C_SelectMemberDbm() {
	...
	C_SelectMemberDbm.ColumnMemberName = df.CCI(&selectMember, "member_name", memberNameSqlName, "", "", "String.class", "memberName", "", false, false,false, "VARCHAR", 180, 0, "",false,"","", "","","",false,"df.NullString")
